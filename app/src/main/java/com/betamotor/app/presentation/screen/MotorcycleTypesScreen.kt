...
fun MotorcycleTypesScreen(
    ...
    val isLoading = motorcycleViewModel.isLoading.collectAsState()

    LaunchedEffect(Unit) {
        val result = motorcycleViewModel.getMotorcycleTypes()
        ...
        Column(
            ...
            if (isLoading.value) {
                ...
                LazyVerticalGrid(
                    ...
                    items(motorcycleViewModel.motorcycleTypes.value) { item ->
                ...
                Button(onClick = {
                    ...
                    .fillMaxWidth()
                    .padding(horizontal = 8.dp), colors = ButtonDefaults.buttonColors(backgroundColor = DefaultRed),) {
                    Text(
...
@Composable
fun GridItem(motorcycle: MotorcycleTypeItem?, navController: NavController, showPermissionDialog: MutableState<Boolean>, context: Context) {
    ...
    fun findDevices(motorcycleCode: Int) {
        ...
        if (bluetoothAdapter?.isEnabled != null && bluetoothAdapter?.isEnabled!! && locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            prefManager.setMotorcycleTypeId(motorcycleCode)
            ...
            Column() {
                ...
                Box(
                    ...
                    modifier = Modifier
                        ...
                        .fillMaxWidth()
                        .clickable {
                            motorcycle?.id?.let { findDevices(it) }
                        },
                ) {
                    Text(
